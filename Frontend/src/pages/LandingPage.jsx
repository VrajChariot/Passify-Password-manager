...
import { useClerk, SignedIn, UserButton, useAuth } from "@clerk/clerk-react";
      ...
      {/* <header className="flex items-center justify-between p-6 shadow-md bg-gray-800">
        ...
        <div>
          <button
            ...
            onClick={() => redirectToSignIn({ returnBackUrl: "/" })}
          >
            Login
          </button>
          <SignedIn>
      ...
      <section className="py-16 px-6 bg-gray-800">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div>
            ...
            <p className="text-gray-300">
              View the code, contribute, or self-host. Your data, your control.
            </p>
          </div>
        </div>
      </section>
