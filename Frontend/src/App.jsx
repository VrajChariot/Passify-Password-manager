...
function App() {
  ...
  function RandomPassGen() {
    ...
    RandomPass.push(uppercaseChars[Math.floor(Math.random() * uppercaseChars.length)]);
    RandomPass.push(lowercaseChars[Math.floor(Math.random() * lowercaseChars.length)]);
    RandomPass.push(numberChars[Math.floor(Math.random() * numberChars.length)]);
    RandomPass.push(specialChars[Math.floor(Math.random() * specialChars.length)]);

    const AllPossibleChars = uppercaseChars + lowercaseChars + numberChars + specialChars;
    for (let i = 4; i < length; i++) {
      RandomPass.push(AllPossibleChars[Math.floor(Math.random() * AllPossibleChars.length)])
    }
